              ...
              <View className="px-5 pb-6">
                ...
                <View className="flex-row mt-6 justify-between bg-white/10 rounded-2xl p-4 border border-white/10 backdrop-blur-sm">
                  <TouchableOpacity
                    ...
                    activeOpacity={0.8}
                    onPress={() => router.push(`/social/follows?userId=${encodeURIComponent(currentUserId ?? '')}&type=followers` as any)}
                  ...
                  <TouchableOpacity
                    className="items-center flex-1 border-r border-white/10"
                    activeOpacity={0.8}
                    onPress={() => router.push(`/social/follows?userId=${encodeURIComponent(currentUserId ?? '')}&type=following` as any)}
                    disabled={!currentUserId}
                  >
                    <Text className="text-white text-xl font-bold" style={{ fontFamily: 'HelveticaNeue-Bold' }}>
