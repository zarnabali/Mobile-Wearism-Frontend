...
const VendorDashboard = () => {
    ...
    const summaryCards = [
        { id: 1, label: 'Products', value: '24', icon: 'cube', color: '#4CAF50', bg: require('../../assets/pictures/wardrobe.jpeg') },
        { id: 2, label: 'Active Ads', value: '8', icon: 'megaphone', color: '#FF6B35', bg: require('../../assets/pictures/shop.jpeg') },
        { id: 3, label: 'Total Sales', value: '$12.5K', icon: 'trending-up', color: '#2196F3', bg: require('../../assets/pictures/social.jpeg') },
        { id: 4, label: 'Engagement', value: '87%', icon: 'heart', color: '#E91E63', bg: require('../../assets/pictures/social2.jpeg') },
    ];
                    ...
                    >
                        ...
                        <View style={{ paddingHorizontal: 20, marginTop: 32 }}>
                            ...
                            <View style={{ gap: 12 }}>
                                ...
                                <TouchableOpacity
                                    onPress={() => router.push('/vendor/ads')}
                                    style={{
                                        backgroundColor: 'rgba(255,255,255,0.05)',
                                        borderWidth: 1,
