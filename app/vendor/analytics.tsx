...
const VendorAnalytics = () => {
    ...
    const productPerformance = [
        { name: 'Classic Denim Jacket', views: '8.2K', clicks: 1245, saves: 324, purchases: 145 },
        { name: 'Casual White Sneakers', views: '5.1K', clicks: 892, saves: 198, purchases: 89 },
        { name: 'Summer Floral Dress', views: '4.3K', clicks: 756, saves: 167, purchases: 67 },
    ];
                    ...
                    >
                        ...
                        <View style={{ paddingHorizontal: 20, marginBottom: 32 }}>
                            ...
                            {productPerformance.map((product, index) => (
                                ...
                                >
                                    <Text style={{ fontSize: 16, fontFamily: 'HelveticaNeue', color: '#fff', marginBottom: 14 }}>
                                        {product.name}
                                    </Text>
